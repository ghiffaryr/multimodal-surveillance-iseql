...
MULTIMODAL_EVENTS: list[EventSpec] = [
    ...
    EventSpec("vehicle_escape", "Vehicle Escape: (engine BEFORE/OVERLAP tire_squeal) UNION (running BEFORE/OVERLAP enter_or_exit_vehicle)", "delta_visual_vehicle_escape", "C", False, "delta_sound_vehicle_escape"),
