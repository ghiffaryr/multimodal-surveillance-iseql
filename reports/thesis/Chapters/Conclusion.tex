...
\begin{enumerate}
  \item \textbf{Object re-identification is essential for tracking-dependent events.} Without it, loitering and vehicle escape are largely missed and handoff detections are spurious, because per-frame ID assignment fragments intervals; for the best model (Gemini 3.6 Flash), loitering rises from 0/5 to 5/5, vehicle escape from 0/5 to 1/5, and handoff from 4/5 to 5/5, lifting visual F1 from 0.706 to 0.847.
  \item \textbf{The LALM achieves perfect precision.} Qwen2-Audio-7B-Instruct attains precision of 1.000 at the optimal 5.0 s / 2.5 s configuration (F1 = 0.788) and an F1 of 0.750 at 2.5 s / 1.25 s (also with precision 1.000), substantially outperforming PANNs CNN14 (F1 = 0.429).
