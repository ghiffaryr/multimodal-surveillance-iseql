...
\begin{enumerate}
  \item \textbf{Object re-identification is essential for tracking-dependent events.} Without it, loitering, vehicle escape, and handoff are largely missed because per-frame ID assignment fragments intervals; for the best model (Gemini 3.6 Flash), loitering rises from 0/5 to 5/5, vehicle escape from 0/5 to 1/5, and handoff from 4/5 to 5/5, lifting visual F1 from 0.706 to 0.847.
